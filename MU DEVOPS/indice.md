...
- [tema10_gen](Administración de Sistemas para Cloud/tema10_gen.md)
- [tema1_gen](Administración de Sistemas para Cloud/tema1_gen.md)
- [tema2](Administración de Sistemas para Cloud/tema2.md)
- [tema2_gen](Administración de Sistemas para Cloud/tema2_gen.md)
- [Script de prueba](Administración de Sistemas para Cloud/tema3.md)
- [Script de prueba](Administración de Sistemas para Cloud/tema3_gen.md)
- [Gestionar los argumentos](Administración de Sistemas para Cloud/tema4.md)
  ...
  - instalacion de las dependencias de nodeJS
  - parada de los procesos de forever
- [Gestionar los argumentos](Administración de Sistemas para Cloud/tema4_gen.md)
  - Preparar el repositorio (apt-get) de mongodb añadir su clave apt
  - Instalar paquetes comunes, servidor, shell, balanceador de shards y herramientas
  - Crear las carpetas de logs y datos con sus permisos
  - Establecer el dueño y el grupo de las carpetas db y log
...
- [cat /proc/cpuinfo](Administración de Sistemas para Cloud/tema5_gen.md)
  - m h dom mon dow user command
- [tema6](Administración de Sistemas para Cloud/tema6.md)
- [tema6_gen](Administración de Sistemas para Cloud/tema6_gen.md)
- [comentario en una linea](Administración de Sistemas para Cloud/tema7.md)
- [comentario en una linea](Administración de Sistemas para Cloud/tema7_gen.md)
- [inicializar y verificar los componentes del nombre de dominio](Administración de Sistemas para Cloud/tema8.md)
  ...
  - crear 5 usuarios de prueba
  - crear 3 grupos y añadir todos los usuarios a todos los grupos
- [inicializar y verificar los componentes del nombre de dominio](Administración de Sistemas para Cloud/tema8_gen.md)
  - guardar la contraseña como un objeto seguro
  - cambiar la contraseña del administrador
  - configurar reglas de firewall necesarias
  - configurar los servidores dns en la NIC
...
- [tema9_gen](Administración de Sistemas para Cloud/tema9_gen.md)
...
- [tema10_gen](Cloud Computing, DevOps y DevOps Culture/tema10_gen.md)
- [tema1_gen](Cloud Computing, DevOps y DevOps Culture/tema1_gen.md)
- [tema2](Cloud Computing, DevOps y DevOps Culture/tema2.md)
- [tema2_gen](Cloud Computing, DevOps y DevOps Culture/tema2_gen.md)
- [tema3](Cloud Computing, DevOps y DevOps Culture/tema3.md)
- [tema3_gen](Cloud Computing, DevOps y DevOps Culture/tema3_gen.md)
- [tema4](Cloud Computing, DevOps y DevOps Culture/tema4.md)
- [tema4_gen](Cloud Computing, DevOps y DevOps Culture/tema4_gen.md)
- [tema5](Cloud Computing, DevOps y DevOps Culture/tema5.md)
- [tema5_gen](Cloud Computing, DevOps y DevOps Culture/tema5_gen.md)
- [tema6](Cloud Computing, DevOps y DevOps Culture/tema6.md)
- [tema6_gen](Cloud Computing, DevOps y DevOps Culture/tema6_gen.md)
- [tema7](Cloud Computing, DevOps y DevOps Culture/tema7.md)
- [tema7_gen](Cloud Computing, DevOps y DevOps Culture/tema7_gen.md)
- [tema8](Cloud Computing, DevOps y DevOps Culture/tema8.md)
- [tema8_gen](Cloud Computing, DevOps y DevOps Culture/tema8_gen.md)
- [tema9](Cloud Computing, DevOps y DevOps Culture/tema9.md)
- [tema9_gen](Cloud Computing, DevOps y DevOps Culture/tema9_gen.md)
...
- [Copyright 2016 Google Inc. All rights reserved.](Herramientas DevOps/Herramientas DevOps Tema 1_gen.md)
  - Licensed under the Apache License, Version 2.0 (the “License”);
  - you may not use this file except in compliance with the License.
  - You may obtain a copy of the License at
  - http://www.apache.org/licenses/LICENSE-2.0
...
- [Herramientas DevOps Tema 2_gen](Herramientas DevOps/Herramientas DevOps Tema 2_gen.md)
- [Herramientas DevOps Tema 3](Herramientas DevOps/Herramientas DevOps Tema 3.md)
- [Herramientas DevOps Tema 3_gen](Herramientas DevOps/Herramientas DevOps Tema 3_gen.md)
- [Herramientas DevOps Tema 4](Herramientas DevOps/Herramientas DevOps Tema 4.md)
- [Herramientas DevOps Tema 4_gen](Herramientas DevOps/Herramientas DevOps Tema 4_gen.md)
...
- […](Herramientas DevOps/Herramientas DevOps Tema 5_gen.md)
  - …
  - …
  - …
  - New resource for the S3 bucket our application will use.
