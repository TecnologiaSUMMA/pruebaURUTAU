...
[Esquema 3](#X68706516f0e2e67b0494b30383cf95dd62249d7)

[Ideas clave 4](#Xc3a3c3aeb923b220d188e49b8909abec5566c6d)

[7.1. Introducción y objetivos 4](#X2cd59a4a4e8b1c54e388314b59945f47140e667)

[7.2. Qué es PowerShell 4](#Xa9bf5095a47040c78cb8d6275dd49f6b32bbc74)

[7.3. *Cmdlets* 5](#Xb9acd22edb0fd80e69fa7bd5dc550afaaa317ae)

[7.4. *Scripts* 11](#X78d36acd810398af5dd4f85b82b607fd9f009f5)

[7.5. Expresiones y otros comandos 20](#X548fda45c155ed0903138ace119bf7be4d9049d)

[7.6. Referencias bibliográficas 24](#Xb0ba390e7a1a2c53a002ac4e3ad0df23049883d)

[A fondo 26](#X20ddac7495d410ff25c13221e8185179f48ecd3)

[Test 27](#Xd4d7099bb27dfbccd99158ad9b26d7fc17095bd)
...
Por ejemplo, la Figura 7 demuestra el uso de Get-Item para obtener un listado de los archivos de c:y para obtener las variables de entorno que empiezan con P.
...
Para obtener una lista de los alias definidos en una sesión, se puede hacer uso de Get-Alias. Con el parámetro por defecto, Get-Alias , se obtiene el comando al que un alias hace referencia y con Get-Alias -Definition se obtienen los alias definidos para ese *cmdlet* (ver Figura 8).
...
ForEach ($file in (Get-ChildItem -Path C:-File)) {
...
Get-ChildItem -Path C:-File | ForEach {
...
﻿ ﻿PS C:> Get-ChildItem -Path C:-File | Sort-Object -Property Extension,Length -Descending
...
﻿ ﻿PS C:> Get-ChildItem -Path C:-File | Where-Object {$\_.Length -gt 100 -and $\_.CreationTime -gt ‘5/1/2020’}
...
﻿PS C:> Get-ChildItem -Path C:-File | Sort-Object -Property Length -Descending | Select-Object -First 2 -Skip 1
...
﻿PS C:> Get-ChildItem -Path C:-File | Sort-Object -Property Length -Descending | Select-Object -First 2 -Skip 1 -Property Length,Name | Export-Csv output.csv

PS C:> Get-Content ..csv
