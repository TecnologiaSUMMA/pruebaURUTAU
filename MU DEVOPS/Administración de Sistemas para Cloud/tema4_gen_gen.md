...
[Esquema 3](#X0c1c87b93e139d93eba83d0040a6f2a1be5e04f)

[Ideas clave 4](#X4a43cc548aa67121ea3b14e7aad14e840ccae8a)

[4.1. Introducción y objetivos 4](#Xa179c07913bf18c55f84fe559e7b5da683f85a5)

[4.2. Caso práctico: instalación de MongoDB 4](#X2a09de93a14f3262991a15bd62b94eb5e9f543b)

[4.3. Caso práctico: instalación de PHP-FPM 16](#Xc79296319fb82ea45070fe65f9965e198849d46)

[4.4. Caso práctico: aplicación genérica de NodeJS 25](#Xce00bb2c534889ef0d5e9be198c5a1a0addc4c8)

[4.5. Caso práctico: automatización en AWS 31](#Xd9855414175dc64032d1b25aba7189b36623e2a)

[4.6. Referencias bibliográficas 36](#X3ae63f3c50be066b33e4f6147164806d95269f3)

[A fondo 39](#X38ff54d883be9b9ccfb27fc8b0baa7262cf5d77)

[Test 40](#X8bb71c52b5d9d4420d0175c6ada825c34b77712)
...
logger “Instalacion completada con exito; visite http:///info.php para comprobarlo”
...
El fichero info.php, creado por el *script*, contiene la función phpinfo() de PHP, que imprime una larga lista de opciones de instalación y módulos en ejecución. Si se recupera el fichero con un navegador y se obtiene un fichero de texto plano con el contenido , la instalación no ha funcionado. Sin embargo, si se obtiene una página como la de la Figura 3, la instalación terminó con éxito.
...
El *log* de salida /var/log/cloud-init-output.log contendrá la salida estándar del *script*. En caso de error, este *log* se puede usar para verificar la salida de los comandos. Además, el *script* se copia a la ruta /var/lib/cloud/instances// al procesarlo, por lo que es posible comprobar que el *script* que se ha ejecutado es efectivamente el deseado.
